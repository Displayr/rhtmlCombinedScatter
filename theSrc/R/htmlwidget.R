    ...
    z.title = "")
{
    ...
    x = list(X = toJSON(X),
             ...
             fitX = fit.x,
             fitY = fit.y,
             fitLowerBound = fit.lower.bound,
             fitUpperBound = fit.upper.bound,
             fitLineColors = fit.line.colors,
             fitLineType = fit.line.type,
             fitLineWidth = fit.line.width,
             fitLineOpacity = fit.line.opacity,
             fitLineNames = fit.line.names,
             fitCIColors = fit.ci.colors,
             fitCILabelColors = fit.ci.label.colors,
